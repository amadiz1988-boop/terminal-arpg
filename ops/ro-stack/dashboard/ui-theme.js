(() => {
  ...
  const themes = deepFreeze([
    ...
    { id: 'heroine-roxy', label: '洛琪希', series: '無職轉生', access: 'OPEN', entitlement: null,
      ...
      variants: [
        { key: 'roxy-01', versions: { panel: '21d5f584', thumb: 'db2bbb27' } },
        { key: 'roxy-02', versions: { panel: 'b60c6229', thumb: '233d6d51' } },
      ] },
    { id: 'heroine-eris', label: '艾莉絲', series: '無職轉生', access: 'OPEN', entitlement: null,
      titleBar: { top: '#d9776a', bottom: '#9a2a24', border: '#6e1a16' },
      variants: [
        { key: 'eris-01', versions: { panel: '3b1c2571', thumb: '5f7cc4c3' } },
        { key: 'eris-02', versions: { panel: 'dcb3ad31', thumb: '62559a18' } },
        { key: 'eris-03', versions: { panel: '9b880d26', thumb: '39409adf' } },
      ] },
    { id: 'heroine-sylphie', label: '希露菲', series: '無職轉生', access: 'OPEN', entitlement: null,
      titleBar: { top: '#9cb77a', bottom: '#4f6d33', border: '#3a5224' },
      variants: [
        { key: 'sylphie-01', versions: { panel: '2b81746d', thumb: '21cc8d4d' } },
        { key: 'sylphie-02', versions: { panel: '34ccf86a', thumb: 'f735e5a2' } },
        { key: 'sylphie-03', versions: { panel: '7425834f', thumb: 'ddb656e5' } },
        { key: 'sylphie-04', versions: { panel: 'f67a5f02', thumb: 'd224e902' } },
        { key: 'sylphie-05', versions: { panel: '842f6c89', thumb: '5e551227' } },
        { key: 'sylphie-06', versions: { panel: '39292cc8', thumb: '0c514397' } },
    ...
    { id: 'heroine-red-dress', label: '妓神', series: '無職轉生', access: 'OPEN', entitlement: null,
      ...
      variants: [
        ...
        { key: 'red-02', versions: { panel: '6c622a22', thumb: 'f89e2c22' } },
        { key: 'red-03', versions: { panel: '940282f0', thumb: 'de749337' } },
        { key: 'red-04', versions: { panel: '0b8785e2', thumb: '932760c4' } },
      ] },
  ]);
