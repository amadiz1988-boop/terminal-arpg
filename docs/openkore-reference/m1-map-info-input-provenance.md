...
| `scripts/import-ro-world-map.mjs`, `scripts/extract-ro-world-map.ps1`, `scripts/extract-ro-monster-names.ps1`, `scripts/build-ro-map-names.mjs` | OTHER_WORKLINE_INPUT | Existing untracked asset-extraction or map-name helpers. They are not invoked by map-info generation and are left untouched and uncommitted by M1. |
