...
and item-warp candidates. Relevant keys include `teleportAuto_hp`, `sp`,
`idle`, `portal`, `search`, `deadly`, `lostTarget`, `dropTarget`,
...
```text
Fly Wing item 601       random map position, escape or search policy
