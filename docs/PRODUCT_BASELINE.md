...
最高層產品契約：`docs/RO_AUTOMATION_PRODUCT_CONSTITUTION.md`。產品固定為「RO 完整養成與 NPC 遊戲性，加上 OpenKore 自動移動及戰鬥，小地圖與終端呈現即時世界」。
...
- 來源不完整的規則維持未實作狀態。
- 任務、轉職、卡普拉、倉庫、商店、補給、排行榜、公會與社交功能均以 rAthena 原生資料或 OpenKore 行為為準。
