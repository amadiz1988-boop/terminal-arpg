...
export const SKILLS: Record<SkillId, SkillDefinition> = {
  ...
  quake: { id: 'quake', name: '玄鐵震地', description: '範圍近戰重擊，生存穩定', tags: ['attack', 'melee', 'area', 'physical'], baseDamage: 1760, attacksPerSecond: 2.1, critChance: 22, moveSpeed: 112, color: '#f87171', socketColor: 'R' },
