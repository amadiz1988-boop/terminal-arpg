...
- 依 rAthena 生成資料建立波利、瘋兔、綠棉蟲、蛹、小波利，共 271 個獨立怪物。
- 怪物依 rAthena 原生成範圍、重生延遲與落點回退規則巡走及重生；停止玩家掛機時，共享世界仍持續運作。
- Base／Job 升級、能力點、全部重置、技能點與初心者基本技能已接入同一份模擬狀態。
- 介面內與 `docs/RO_RESTORATION_PROGRESS.md` 同步顯示可驗證還原度。
